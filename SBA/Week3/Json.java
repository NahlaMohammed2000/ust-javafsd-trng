...
public class Json {
	public static void main(String args[]) {
		...
		try {
			FileReader f = new FileReader("C:\\Users\\ustjavafsdb224\\Downloads\\EmployeeData.json");
			JSONArray a = (JSONArray)p.parse(f);
			
			
			FileOutputStream ofile =new FileOutputStream("C:\\Users\\ustjavafsdb224\\Downloads\\Employee.xlsx");
